...
3. Теперь мы должны объединить полигоны из наборов $P_{\alpha_j}$ в компоненты связности. Сделать это можно двумя способами 
